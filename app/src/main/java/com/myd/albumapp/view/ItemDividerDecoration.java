...
public class ItemDividerDecoration extends RecyclerView.ItemDecoration {
    ...
    ItemDividerDecoration(Drawable drawableDivider) {
        this.drawableDivider = drawableDivider;
    }
    ...
    public void onDraw(Canvas canvas, RecyclerView parent, RecyclerView.State state) {
        ...
        for (int i = 0; i < childCount - 1; i++) {
            ...
            int dividerBottom = dividerTop + drawableDivider.getIntrinsicHeight();
